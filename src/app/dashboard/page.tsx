          ...
          {activeSection === "servicii" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              {(() => {
                ...
                const svcStats = tabServices.map((svc:any) => ({
                  ...svc,
                ...
                const avgPrice = tabServices.length > 0 ? Math.round(tabServices.reduce((a:number,s:any) => a + (s.price||0), 0) / tabServices.length) : 0;
                return (
                  <>
                  ...
                  <div style={{ background: s.surface, border: `1px solid ${s.border}`, borderRadius: 14, padding: isMobile ? 14 : 18, marginBottom: 10 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                      {tabServices.map((svc:any, idx:number) => {
                        ...
                        const maxBk = Math.max(...tabServices.map((s:any) => bookings.filter((b:any) => b.service?.id === s.id).length), 1);
